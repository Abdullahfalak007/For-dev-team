...
import { fetchChatHistory } from "../store/thunks/chatHistoryThunk";
import "../index.css"; // Ensure this import is present for custom scrollbar styles
...
const CallHistoryPage = () => {
  ...
  const chatHistory = useSelector((state) => state.chatHistory.data);
  const chatHistoryStatus = useSelector((state) => state.chatHistory.status);

  useEffect(() => {
    if (chatHistoryStatus === "idle") {
      dispatch(fetchChatHistory());
    }
  }, [chatHistoryStatus, dispatch]);
