...
const ChatHistory = ({ file, onClose }) => {
  return (
    <div className="flex-1 p-4">
      <div className="flex justify-between items-center mb-4">
        <div className="flex flex-col">
      ...
      >
        ...
        {file.clientMessages.map((message) => (
          <div key={message.id} className="relative mb-8 text-left self-start">
            <h3 className="text-customBlue font-poppins text-[1.12625rem] font-semibold leading-normal">
              Client
            </h3>
            <div className="relative">
        ...
        {file.userMessages.map((message) => (
          <div key={message.id} className="relative mb-8 text-right self-start">
            <h3 className="text-customBlue font-poppins text-[1.12625rem] font-semibold leading-normal">
              User
            </h3>
            <div className="relative">
        ...
        {/* Render AI responses */}
        {file.aiResponses.map((response) => (
          <div key={response.id} className="relative mb-8 text-left self-start">
            <h3 className="text-customBlue font-poppins text-[1.12625rem] font-semibold leading-normal">
              AI Assistant
            </h3>
            <div className="relative">
        ...
        {file.inputMessages.map((message) => (
          <div key={message.id} className="relative mb-8 text-right self-start">
            <h3 className="text-customBlue font-poppins text-[1.12625rem] font-semibold leading-normal">
              User Input
            </h3>
