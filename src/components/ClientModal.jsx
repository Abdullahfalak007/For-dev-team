...
//               type="button"
//               onClick={onSave}
//               className="bg-blue-500 text-white px-6 py-2 -mt-2 rounded-full mr-2"
//             >
...
const ClientModal = ({
  ...
  const handleChange = (e) => {
    const { name, value } = e.target;
    if (name === "virtualAssistant.name") {
      setFormData({
        ...formData,
        virtualAssistant: { ...formData.virtualAssistant, name: value },
      });
    } else {
      setFormData({ ...formData, [name]: value });
    }
      ...
      >
        ...
        <form className="px-8 pt-12">
          ...
          <FormField
            ...
            value={formData.virtualAssistant?.name || ""}
            onChange={handleChange}
          />
          <FormField
            label="Email"
          ...
          <div className="flex justify-center">
            <button
              ...
              className="bg-blue-500 text-white px-6 py-2 -mt-2 rounded-full mr-2"
            >
              {isEditMode ? "Save Client" : "Add Client"}
            </button>
          </div>
        </form>
      </div>
